...
# (such as a list, tuple, or string) and get the index and value of each element in the sequence at 
# the same time. Here's a basic example of how it works:
...
# The enumerate function is often used when you need to loop over a sequence and perform some action 
# with both the index and value of each element. 
# For example, you might use it to loop over a list of strings and 
